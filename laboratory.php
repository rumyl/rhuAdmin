...
if(isset($_POST['btn_upload'])) {
  ...
  $tableName = 'tbl_laboratory';

  $labFile = $_FILES['lab_file'];

  // Validate file upload
  if ($labFile['error'] === UPLOAD_ERR_OK && $labFile['type'] === 'application/pdf') {
      
      // Move uploaded file to a specific directory
      $uploadDirectory = 'uploads/';
      $uploadedFilePath = $uploadDirectory . basename($labFile['name']);

      if (move_uploaded_file($labFile['tmp_name'], $uploadedFilePath)) {
          
          // Data to insert into the database
          $dataToInsert = array(
              'lab_file'       => $uploadedFilePath,
          ...
          if($inserted) {
              ...
              $display = "block";
              echo '<meta http-equiv="refresh" content="2;url=laboratory">';
          } else {
              $alert = "error";
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success card-outline">
                <div class="card-header">
                  <h3 class="card-title">Upload Laboratory Results</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  <div class="card-body">
                    ...
                    <div class="form-group">
                          ...
                          <textarea name="lab_details" class="form-control" style="min-height:200px;max-height:200px;"></textarea>
                          <input type="file" id="pdfFile" name="lab_file" accept="application/pdf" required>
                    </div>
