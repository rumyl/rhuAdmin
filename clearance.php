  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Brgy Clearance</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Application for Brgy Clearance</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  <div class="card-body">
  ...
  $(document).on('click', '#btn_print', function(){  
        ...
        var req_date = $('#req_date').val();
              ...
              $.ajax({  
                    ...
                    window.open('print_clearance.php?res_id='+res_id+'&req_date='+req_date, 'Print Sales Invoice', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
                }
             });
